...
export function useVapi(book: IBook) {
  ...
  const start = useCallback(async () => {
    ...
    try {
      ...
      const firstMessage = `Hi! It is wonderful to meet you. I am excited to explore ${book.title} with you today. Before we begin, I would love to know where you are in your reading journey. Have you already read the book, read part of it, or are we starting from the very beginning? That way, I can tailor our conversation to you.`;
